...
function wordSearch() {
 ...
 request3.open('GET', 'https://api.wordnik.com/v4/word.json/' + wordToSearch + '/audio?useConanical=false&limit=50&api_key=e0d094e089e87c411680f08f6ab0e7be39143f84626e8c9e4', true);
